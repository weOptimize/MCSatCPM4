...
def threshold_calculation(df10r):
    ...
    simulatescenario(df10r, deterministic_portfolio, projectselection)
    ...
    reduced_deterministic_portfolios = [0] * len(zipped_projection_indexes)
    ...
    for i in range(len(zipped_projection_indexes)):
        ...
        # multiply by zero the element that corresponds to the position inside zipped projection indexes
    ...
    for i in range(len(zipped_projection_indexes)):
        ...
        reduced_deterministic_portfolios_results.append(simulatescenario(df10r, reduced_deterministic_portfolios[i], projectselection))
