...
nrcandidates = 20
iterations = 500 #was 300 #was 500
...
df10r = NONcorrelatedMCS(mcs_results1, iterations, nrcandidates, initial_projection_indexes)
# print("df10r: ", df10r)
...
df20r = NONcorrelatedMCS(mcs_results2, iterations_finalMCS, projected_candidates, zipped_projection_indexes)
